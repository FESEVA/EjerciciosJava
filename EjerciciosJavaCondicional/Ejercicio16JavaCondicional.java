...
*/
public class Ejercicio16JavaCondicional {
	public static void main(String[] args) {
		Scanner s = new Scanner(System.in);
		System.out.println("Bienvenido al programa que dice si tu pareja te es infiel, respondiendo a una serie de preguntas con s de (sí) o n de (no): ");    
    char respuesta = 0;
    int puntos = 0;
